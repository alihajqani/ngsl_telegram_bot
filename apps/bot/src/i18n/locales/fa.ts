...
export const fa = {
  ...
  start: {
    ...
    guide:
      ...
      '🔎 <b>جست‌وجو</b> — هر واژه یا عبارت انگلیسی را تایپ کنید و در کلیپ‌ها ببینید\n' +
  ...
  newWords: {
    ...
    next: 'واژهٔ بعدی ⏭ ({position}/{total})',
    ended: 'این جلسه تمام شده است. برای واژه‌های تازه، «{button}» را بزنید.',
  ...
  search: {
    prompt:
      '🔎 یک واژه یا عبارت انگلیسی بفرستید تا آن را در گفتار واقعی ببینید.\n' +
      'مثلاً: <code>look forward to</code>',
    none: 'برای «{query}» هنوز کلیپی نداریم.',
    invalid: 'فقط حروف انگلیسی بفرستید، حداکثر ۶ کلمه.',
  },
  ...
  writing: {
    ...
    notEnoughWords:
      '📚 برای تمرین نوشتن دست‌کم ۳ واژه لازم است.\n' +
      'اول از «📖 واژه‌های جدید» چند واژه یاد بگیرید.',
  ...
  settings: {
    ...
    digestStopped: '🔕 جدول‌های شبانه خاموش شد. از ⚙️ تنظیمات می‌توانید دوباره روشنش کنید.',
